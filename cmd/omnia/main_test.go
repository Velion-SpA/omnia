...
func TestPrintUsage(t *testing.T) {
	...
	if !strings.Contains(stdout, "omnia vtest-version") {
...
func TestPrintPostInstall(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			notExpects: []string{"opencode-subagent-statusline", "omnia serve &"},
		},
		{
			name:       "pi",
...
func TestMainVersionAndHelpAliases(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "version", arg: "version", contains: "omnia 9.9.9-test", notStderr: true},
		{name: "version short", arg: "-v", contains: "omnia 9.9.9-test", notStderr: true},
		{name: "version long", arg: "--version", contains: "omnia 9.9.9-test", notStderr: true},
...
func TestMainExitPaths(t *testing.T) {
	tests := []struct {
		...
		{name: "cloud missing subcommand", helperCase: "cloud-missing", expectedOutput: "usage: omnia cloud", expectedExitOne: true},
		...
		{name: "cloud enroll missing project", helperCase: "cloud-enroll-missing", expectedOutput: "usage: omnia cloud enroll <project>", expectedExitOne: true},
	}
