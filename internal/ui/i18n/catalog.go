...
var messages = map[string]map[Lang]string{
	...
	"admin.projects.memScopeAll":            {LangES: "Incluir sub-proyectos", LangEN: "Include sub-projects"},
	"admin.projects.memScopeOwn":            {LangES: "Solo este proyecto", LangEN: "This project only"},
