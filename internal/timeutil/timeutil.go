...
// the default layout ("2006-01-02 15:04:05"). When OMNIA_TIMEZONE is unset or invalid
...
// specific display style while still honoring OMNIA_TIMEZONE.
//
